...
control SwitchIngress(
    ...
    table match_princeton_src {
        ...
        const entries = {
            (32w0x80700000 &&& 32w0xffff0000): set_princeton_src_matched(1);
            (32w0x8cb40000 &&& 32w0xffff0000): set_princeton_src_matched(1);
            (32w0xcc993000 &&& 32w0xfffffe00): set_princeton_src_matched(1);
            (32w0x42b4b000 &&& 32w0xffffff00): set_princeton_src_matched(1);
            (32w0x42b4b100 &&& 32w0xffffff00): set_princeton_src_matched(1);
            (32w0x42b4b400 &&& 32w0xfffffc00): set_princeton_src_matched(1);
            (32w0xc0a80000 &&& 32w0xffff0000): set_princeton_src_matched(1);
            (32w0xac100000 &&& 32w0xfff00000): set_princeton_src_matched(1);
            (32w0x0a000000 &&& 32w0xff000000): set_princeton_src_matched(1);
        }
    ...
    table match_princeton_dst {
        ...
        const entries = {
            (32w0x80700000 &&& 32w0xffff0000): set_princeton_dst_matched(1);
            (32w0x8cb40000 &&& 32w0xffff0000): set_princeton_dst_matched(1);
            (32w0xcc993000 &&& 32w0xfffffe00): set_princeton_dst_matched(1);
            (32w0x42b4b000 &&& 32w0xffffff00): set_princeton_dst_matched(1);
            (32w0x42b4b100 &&& 32w0xffffff00): set_princeton_dst_matched(1);
            (32w0x42b4b400 &&& 32w0xfffffc00): set_princeton_dst_matched(1);
            (32w0xc0a80000 &&& 32w0xffff0000): set_princeton_dst_matched(1);
            (32w0xac100000 &&& 32w0xfff00000): set_princeton_dst_matched(1);
            (32w0x0a000000 &&& 32w0xff000000): set_princeton_dst_matched(1);
        }
...
control SwitchEgress(
    ...
    apply {
        ...
        eg_md.src_hash_mac_id = (bit<24>) crc32_src_mac_id.get(hdr.ethernet.src_addr_id);
       ...
       // Anonymize SRC MAC
        ...
        if (hdr.ethernet.dst_addr_oui!=0xffffff) {
            if (hdr.ethernet.dst_addr_id!=0xffffff) {
                if (eg_md.dst_mac_mc_oui!=0x010000) {
                    ...
                    eg_md.dst_hash_mac_id  = (bit<24>) crc32_dst_mac_id.get(hdr.ethernet.dst_addr_id);
        ...
        if (eg_md.lets_hash_srcip == 0) {
            ...
            if (eg_md.srcip_subnetmask == 0x0) {
                eg_md.srcip_hash_part = crc32.get(eg_md.srcip_hash_part);
                ...
                eg_md.srcip_hash_part8 = (bit<8>) crc16.get(eg_md.srcip_hash_part);
                eg_md.srcip_hash_part = (bit<32>) eg_md.srcip_hash_part8;
        ...
        if (eg_md.lets_hash_dstip == 0) {
            ...
            if (eg_md.dstip_subnetmask == 0x0) {
                eg_md.dstip_hash_part = crc32d.get(eg_md.dstip_hash_part);
                //hashing_dst0_tb.apply();
            }
            else if (eg_md.dstip_subnetmask == 0xff000000) {
                eg_md.dstip_hash_part24 = (bit<24>) crc32d.get(eg_md.dstip_hash_part);
                eg_md.dstip_hash_part = (bit<32>) eg_md.dstip_hash_part24;
                //hashing_dst8_tb.apply();
            }
            else if (eg_md.dstip_subnetmask == 0xffff0000) {
                eg_md.dstip_hash_part16 = (bit<16>) crc16d.get(eg_md.dstip_hash_part);
                eg_md.dstip_hash_part = (bit<32>) eg_md.dstip_hash_part16;
                //hashing_dst16_tb.apply();
            }
            else {
                eg_md.dstip_hash_part8 = (bit<8>) crc16d.get(eg_md.dstip_hash_part);
                eg_md.dstip_hash_part = (bit<32>) eg_md.dstip_hash_part8;
