...
#define SALT_24 24w0xcccccc
#define SALT_32 32w0x0ccccccc
...
control SwitchIngress(
    ...
    table match_princeton_src {
        ...
        const entries = {
            ( 32w0x80700000 &&& 32w0xffff0000, _): set_princeton_src_matched();
            ( 32w0x8cb40000 &&& 32w0xffff0000, _): set_princeton_src_matched();
            ( 32w0xcc993000 &&& 32w0xfffffe00, _): set_princeton_src_matched();
            ( 32w0x42b4b000 &&& 32w0xffffff00, _): set_princeton_src_matched();
            ( 32w0x42b4b100 &&& 32w0xffffff00, _): set_princeton_src_matched();
            ( 32w0x42b4b400 &&& 32w0xfffffc00, _): set_princeton_src_matched();
            ( 32w0xc0a80000 &&& 32w0xffff0000, _): set_princeton_src_matched();
            ( 32w0xac100000 &&& 32w0xfff00000, _): set_princeton_src_matched();
            ( 32w0x0a000000 &&& 32w0xff000000, _): set_princeton_src_matched();
    ...
    table match_princeton_dst {
        ...
        const entries = {
            ( _, 32w0x80700000 &&& 32w0xffff0000): set_princeton_dst_matched();
            ( _, 32w0x8cb40000 &&& 32w0xffff0000): set_princeton_dst_matched();
            ( _, 32w0xcc993000 &&& 32w0xfffffe00): set_princeton_dst_matched();
            ( _, 32w0x42b4b000 &&& 32w0xffffff00): set_princeton_dst_matched();
            ( _, 32w0x42b4b100 &&& 32w0xffffff00): set_princeton_dst_matched();
            ( _, 32w0x42b4b400 &&& 32w0xfffffc00): set_princeton_dst_matched();
            ( _, 32w0xc0a80000 &&& 32w0xffff0000): set_princeton_dst_matched();
            ( _, 32w0xac100000 &&& 32w0xfff00000): set_princeton_dst_matched();
            ( _, 32w0x0a000000 &&& 32w0xff000000): set_princeton_dst_matched();
